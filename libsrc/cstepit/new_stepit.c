...
int new_stepit (void (*cstepit_fn)(void))
{
...
void new_setfobj(double value)
{
	fobj = value;
}

void new_getvals(double *arr, int n)
{
	int i;
...
void new_setvals(double *arr, int n)
{
	int i;
...
void new_setminmax(double *minarr, double *maxarr, int n)
{
	int i;
...
void new_setdelta(double *delarr, double *dmnarr, int n)
{
	int i;
...
void new_settrace(int nt)
{
	ntrace = nt;
}

void new_setmaxcalls(int n)
{
}
