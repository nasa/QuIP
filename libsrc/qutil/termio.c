...
char VersionId_qutil_termio[] = QUIP_VERSION_STRING;
...
void show_term_flags(u_long flag,Termio_Option *tbl)
{
...
void dump_term_flags(u_long flag, Termio_Option *tbl)
{
	while(tbl->to_name != NULL ){
		if( flag & tbl->to_bit ){
