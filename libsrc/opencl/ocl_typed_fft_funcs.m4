...
void HOST_TYPED_CALL_NAME(rvift,type_code)(HOST_CALL_ARG_DECLS)
{ warn("HOST_TYPED_CALL_NAME(rvift,type_code) not implemented!?"); }

void HOST_TYPED_CALL_NAME(cvfft,type_code)(HOST_CALL_ARG_DECLS)
{ warn("HOST_TYPED_CALL_NAME(cvfft,type_code) not implemented!?"); }

void HOST_TYPED_CALL_NAME(cvift,type_code)(HOST_CALL_ARG_DECLS)
{ warn("HOST_TYPED_CALL_NAME(cvift,type_code) not implemented!?"); }
