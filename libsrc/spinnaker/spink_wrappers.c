...
SPINK_WRAPPER_ONE_ARG(release_image,ImageRelease,spinImage,hImage)
...
SPINK_WRAPPER_TWO_ARG(DeviceEventGetId,spinDeviceEventData,hDeviceEventData,uint64_t*,pEventId)
SPINK_WRAPPER_TWO_ARG(DeviceEventGetPayloadDataSize,spinDeviceEventData,hDeviceEventData,size_t*,pBufSize)
...
SPINK_WRAPPER_TWO_ARG(NodeMapGetNumNodes,spinNodeMapHandle,hNodeMap,size_t*,pValue)
SPINK_WRAPPER_TWO_ARG(NodeMapPoll,spinNodeMapHandle,hNodeMap,int64_t,timestamp)
SPINK_WRAPPER_TWO_ARG(NodeIsImplemented,spinNodeHandle,hNode,bool8_t*,pbResult)
SPINK_WRAPPER_TWO_ARG(NodeIsReadable,spinNodeHandle,hNode,bool8_t*,pbResult)
SPINK_WRAPPER_TWO_ARG(NodeIsWritable,spinNodeHandle,hNode,bool8_t*,pbResult)
SPINK_WRAPPER_TWO_ARG(NodeIsAvailable,spinNodeHandle,hNode,bool8_t*,pbResult)
SPINK_WRAPPER_TWO_ARG(NodeGetAccessMode,spinNodeHandle,hNode,spinAccessMode*,pAccessMode)
SPINK_WRAPPER_TWO_ARG(NodeGetNameSpace,spinNodeHandle,hNode,spinNameSpace*,pNamespace)
SPINK_WRAPPER_TWO_ARG(NodeGetVisibility,spinNodeHandle,hNode,spinVisibility*,pVisibility)
SPINK_WRAPPER_TWO_ARG(NodeGetCachingMode,spinNodeHandle,hNode,spinCachingMode*,pCachingMode)
SPINK_WRAPPER_TWO_ARG(NodeGetType,spinNodeHandle,hNode,spinNodeType*,pType)
SPINK_WRAPPER_TWO_ARG(NodeGetPollingTime,spinNodeHandle,hNode,int64_t*,pPollingTime)
SPINK_WRAPPER_TWO_ARG(NodeDeregisterCallback,spinNodeHandle,hNode,spinNodeCallbackHandle,hCb)
SPINK_WRAPPER_TWO_ARG(NodeGetImposedAccessMode,spinNodeHandle,hNode,spinAccessMode,imposedAccessMode)
SPINK_WRAPPER_TWO_ARG(NodeGetImposedVisibility,spinNodeHandle,hNode,spinVisibility,imposedVisibility)
SPINK_WRAPPER_TWO_ARG(NodeFromString,spinNodeHandle,hNode,const char*,pBuf)
SPINK_WRAPPER_TWO_ARG(StringSetValue,spinNodeHandle,hNode,const char*,pBuf)
SPINK_WRAPPER_TWO_ARG(StringGetMaxLength,spinNodeHandle,hNode,int64_t*,pValue)
SPINK_WRAPPER_TWO_ARG(IntegerSetValue,spinNodeHandle,hNode,int64_t,value)
SPINK_WRAPPER_TWO_ARG(IntegerGetValue,spinNodeHandle,hNode,int64_t*,pValue)
SPINK_WRAPPER_TWO_ARG(IntegerGetMin,spinNodeHandle,hNode,int64_t*,pValue)
SPINK_WRAPPER_TWO_ARG(IntegerGetMax,spinNodeHandle,hNode,int64_t*,pValue)
SPINK_WRAPPER_TWO_ARG(IntegerGetInc,spinNodeHandle,hNode,int64_t*,pValue)
SPINK_WRAPPER_TWO_ARG(IntegerGetRepresentation,spinNodeHandle,hNode,spinRepresentation*,pValue)
SPINK_WRAPPER_TWO_ARG(FloatSetValue,spinNodeHandle,hNode,double,value)
SPINK_WRAPPER_TWO_ARG(FloatGetValue,spinNodeHandle,hNode,double*,pValue)
SPINK_WRAPPER_TWO_ARG(FloatGetMin,spinNodeHandle,hNode,double*,pValue)
SPINK_WRAPPER_TWO_ARG(FloatGetMax,spinNodeHandle,hNode,double*,pValue)
SPINK_WRAPPER_TWO_ARG(FloatGetRepresentation,spinNodeHandle,hNode,spinRepresentation*,pValue)
SPINK_WRAPPER_TWO_ARG(EnumerationGetNumEntries,spinNodeHandle,hNode,size_t*,pValue)
SPINK_WRAPPER_TWO_ARG(EnumerationGetCurrentEntry,spinNodeHandle,hNode,spinNodeHandle*,phEntry)
SPINK_WRAPPER_TWO_ARG(EnumerationSetIntValue,spinNodeHandle,hNode,int64_t,value)
SPINK_WRAPPER_TWO_ARG(EnumerationSetEnumValue,spinNodeHandle,hNode,size_t,value)
SPINK_WRAPPER_TWO_ARG(EnumerationEntryGetIntValue,spinNodeHandle,hNode,int64_t*,pValue)
SPINK_WRAPPER_TWO_ARG(EnumerationEntryGetEnumValue,spinNodeHandle,hNode,size_t*,pValue)
SPINK_WRAPPER_TWO_ARG(BooleanSetValue,spinNodeHandle,hNode,bool8_t,value)
SPINK_WRAPPER_TWO_ARG(BooleanGetValue,spinNodeHandle,hNode,bool8_t*,pbValue)
SPINK_WRAPPER_TWO_ARG(CommandIsDone,spinNodeHandle,hNode,bool8_t*,pbValue)
...
SPINK_WRAPPER_THREE_ARG(ImageConvert,spinImage,hSrcImage,spinPixelFormatEnums,pixelFormat,spinImage,hDestImage)
SPINK_WRAPPER_THREE_ARG(ImageGetPixelFormatName,spinImage,hImage,char*,pBuf,size_t*,pLen)
...
SPINK_WRAPPER_THREE_ARG(ImageGetStatusDescription,spinImageStatus,status,char*,pBuf,size_t*,pLen)
SPINK_WRAPPER_THREE_ARG(DeviceEventCreate,spinDeviceEvent*,phDeviceEvent,spinDeviceEventFunction,pFunction,void*,pUserData)
SPINK_WRAPPER_THREE_ARG(ImageEventCreate,spinImageEvent*,phImageEvent,spinImageEventFunction,pFunction,void*,pUserData)
SPINK_WRAPPER_THREE_ARG(ArrivalEventCreate,spinArrivalEvent*,phArrivalEvent,spinArrivalEventFunction,pFunction,void*,pUserData)
SPINK_WRAPPER_THREE_ARG(RemovalEventCreate,spinRemovalEvent*,phRemovalEvent,spinRemovalEventFunction,pFunction,void*,pUserData)
SPINK_WRAPPER_THREE_ARG(LogEventCreate,spinLogEvent*,phLogEvent,spinLogEventFunction,pFunction,void*,pUserData)
SPINK_WRAPPER_THREE_ARG(ImageStatisticsGetChannelStatus,spinImageStatistics,hStatistics,spinStatisticsChannel,channel,bool8_t*,pbEnabled)
SPINK_WRAPPER_THREE_ARG(ImageStatisticsSetChannelStatus,spinImageStatistics,hStatistics,spinStatisticsChannel,channel,bool8_t,bEnable)
SPINK_WRAPPER_THREE_ARG(ImageStatisticsGetNumPixelValues,spinImageStatistics,hStatistics,spinStatisticsChannel,channel,unsigned int*,pNumValues)
SPINK_WRAPPER_THREE_ARG(ImageStatisticsGetMean,spinImageStatistics,hStatistics,spinStatisticsChannel,channel,float*,pMean)
SPINK_WRAPPER_THREE_ARG(ImageStatisticsGetHistogram,spinImageStatistics,hStatistics,spinStatisticsChannel,channel,int**,ppHistogram)
SPINK_WRAPPER_THREE_ARG(LogDataGetCategoryName,spinLogEventData,hLogEventData,char*,pBuf,size_t*,pLen)
SPINK_WRAPPER_THREE_ARG(LogDataGetPriorityName,spinLogEventData,hLogEventData,char*,pBuf,size_t*,pLen)
SPINK_WRAPPER_THREE_ARG(LogDataGetTimestamp,spinLogEventData,hLogEventData,char*,pBuf,size_t*,pLen)
SPINK_WRAPPER_THREE_ARG(LogDataGetNDC,spinLogEventData,hLogEventData,char*,pBuf,size_t*,pLen)
SPINK_WRAPPER_THREE_ARG(LogDataGetThreadName,spinLogEventData,hLogEventData,char*,pBuf,size_t*,pLen)
SPINK_WRAPPER_THREE_ARG(LogDataGetLogMessage,spinLogEventData,hLogEventData,char*,pBuf,size_t*,pLen)
SPINK_WRAPPER_THREE_ARG(DeviceEventGetPayloadData,spinDeviceEventData,hDeviceEventData,const uint8_t*,pBuf,size_t*,pBufSize)
SPINK_WRAPPER_THREE_ARG(DeviceEventGetName,spinDeviceEventData,hDeviceEventData,char*,pBuf,size_t*,pLen)
...
SPINK_WRAPPER_THREE_ARG(ImageChunkDataGetIntValue,spinImage,hImage,const char*,pName,int64_t*,pValue)
SPINK_WRAPPER_THREE_ARG(ImageChunkDataGetFloatValue,spinImage,hImage,const char*,pName,double*,pValue)
SPINK_WRAPPER_THREE_ARG(NodeMapGetNode,spinNodeMapHandle,hNodeMap,const char*,pName,spinNodeHandle*,phNode)
SPINK_WRAPPER_THREE_ARG(NodeMapGetNodeByIndex,spinNodeMapHandle,hNodeMap,size_t,index,spinNodeHandle*,phNode)
SPINK_WRAPPER_THREE_ARG(NodeIsEqual,spinNodeHandle,hNodeFirst,spinNodeHandle,hNodeSecond,bool8_t*,pbResult)
SPINK_WRAPPER_THREE_ARG(NodeGetName,spinNodeHandle,hNode,char*,pBuf,size_t*,pLen)
SPINK_WRAPPER_THREE_ARG(NodeGetToolTip,spinNodeHandle,hNode,char*,pBuf,size_t*,pLen)
SPINK_WRAPPER_THREE_ARG(NodeGetDescription,spinNodeHandle,hNode,char*,pBuf,size_t*,pLen)
SPINK_WRAPPER_THREE_ARG(NodeGetDisplayName,spinNodeHandle,hNode,char*,pBuf,size_t*,pLen)
SPINK_WRAPPER_THREE_ARG(NodeRegisterCallback,spinNodeHandle,hNode,spinNodeCallbackFunction,pCbFunction,spinNodeCallbackHandle*,phCb)
SPINK_WRAPPER_THREE_ARG(NodeToString,spinNodeHandle,hNode,char*,pBuf,size_t*,pLen)
...
SPINK_WRAPPER_THREE_ARG(StringGetValue,spinNodeHandle,hNode,char*,pBuf,size_t*,pLen)
...
SPINK_WRAPPER_THREE_ARG(FloatGetUnit,spinNodeHandle,hNode,char*,pBuf,size_t*,pLen)
SPINK_WRAPPER_THREE_ARG(EnumerationGetEntryByIndex,spinNodeHandle,hNode,size_t,index,spinNodeHandle*,phEntry)
SPINK_WRAPPER_THREE_ARG(EnumerationGetEntryByName,spinNodeHandle,hNode,const char*,pName,spinNodeHandle*,phEntry)
SPINK_WRAPPER_THREE_ARG(EnumerationEntryGetSymbolic,spinNodeHandle,hNode,char*,pBuf,size_t*,pLen)
SPINK_WRAPPER_THREE_ARG(CategoryGetFeatureByIndex,spinNodeHandle,hNode,size_t,index,spinNodeHandle*,phFeature)
SPINK_WRAPPER_THREE_ARG(RegisterGet,spinNodeHandle,hNode,uint8_t*,pBuf,int64_t,length)
SPINK_WRAPPER_THREE_ARG(RegisterSet,spinNodeHandle,hNode,const uint8_t*,pBuf,int64_t,length)
