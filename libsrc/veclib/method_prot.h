...
// These definitions might be fused with the new ones in opencl?
...
#define TWO_VEC_CONV_METHOD(n,p,s)	TWO_VEC_METHOD(n,s)
...
#define   EXTREMA_LOCATIONS_METHOD(          name , c1, c2, statement, gpu_c1, gpu_c2 )	\
...
// What are these?
#define   PROJECTION_METHOD_IDX_2( name, s1 , s2, gpu_s1, gpu_s2  )	\
...
#define   PROJECTION_METHOD_2(         name, statement1, statement2, gpu_expr )	\
...
#define    CPX_PROJECTION_METHOD_2(         name, statement1, statement2, gpu_re_expr, gpu_im_expr )	\
...
#define    QUAT_PROJECTION_METHOD_2(         name, statement1, statement2, gpu_re_expr, gpu_im_expr1, gpu_im_expr2, gpu_im_expr3 )	\
