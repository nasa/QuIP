...
extern double get_sound_seconds(QSP_ARG_DECL  Item *dp,dimension_t frame);
extern double get_sound_milliseconds(QSP_ARG_DECL  Item *dp,dimension_t frame);
extern double get_sound_microseconds(QSP_ARG_DECL  Item *dp,dimension_t frame);
