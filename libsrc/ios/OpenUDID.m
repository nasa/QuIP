...
fprintf(stderr,"Generated UDID string %s\n",_openUDID.UTF8String);
}
...
fprintf(stderr,"OpenUDID session cache is nil\n");
...
fprintf(stderr,"creating new uuid\n");
        
        CFUUIDRef uuid = CFUUIDCreate(NULL);
        appUID = (NSString *) CFBridgingRelease(CFUUIDCreateString(NULL, uuid));
        //CFRelease(uuid);  // jbm commented out for ARC
        //[appUID autorelease];
    }
...
fprintf(stderr,"Have UDID from local prefs?\n");
    ...
    //return kOpenUDIDSessionCache;
fprintf(stderr,"returning nil instead of kOpenUDIDSessionCache\n");
    return NULL;
}
