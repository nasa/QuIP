...
define(`XFER_SLOW_ARGS',XFER_SLOW_ARGS_$1$2$3$4)
define(`XFER_EQSP_ARGS',XFER_EQSP_ARGS_$1$2$3$4)
define(`XFER_FAST_ARGS',XFER_FAST_ARGS_$1$2$3$4)

define(`XFER_FAST_ARGS_NOCC',`XFER_SLOW_ARGS_1 /* why SLOW? */ XFER_FAST_COUNT(SRC1_DP) XFER_FAST_ARGS_SRC1 XFER_RETSCAL1 XFER_RETSCAL2')
...
define(`XFER_FAST_ARGS_1',`XFER_DEST_PTR XFER_FAST_COUNT(dst_dp)')
...
define(`XFER_SLOW_ARGS_1',`SLOW_ARGS_SETUP XFER_DEST_PTR
...
define(`XFER_SLOW_ARGS_SRC',`XFER_SRC_PTR($1) XFER_SLOW_SRC_SHAPE($1)')
/*show_vec_args(vap);*/
...
define(`XFER_EQSP_DEST_INC',`
	SET_VA_DEST_EQSP_INC(vap, OBJ_TYPE_INC($1,OBJ_MINDIM($1) ) );
')
...
define(`XFER_EQSP_ARGS_1',`
	SET_VA_FLAGS(vap,VA_EQSP_ARGS);
XFER_FAST_ARGS_1 XFER_EQSP_INC_1')
