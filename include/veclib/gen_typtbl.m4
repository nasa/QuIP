...
ifdef(`USE_SSE',`
define(`SIMD_NAME',`simd_$1')
',` dnl else /* ! USE_SSE */
define(`SIMD_NAME',nullobjf)
') dnl endif /* ! USE_SSE */
...
define(`ALL_REAL_SAME_PREC_NO_BITMAP_SSE',`
	HOST_TYPED_CALL_NAME_REAL($1,by),
	HOST_TYPED_CALL_NAME_REAL($1,in),
	HOST_TYPED_CALL_NAME_REAL($1,di),
	HOST_TYPED_CALL_NAME_REAL($1,li),
...
define(`ALL_REAL_SAME_PREC_NO_GPUBITMAP_SSE',`
	HOST_TYPED_CALL_NAME_REAL($1,by),
	HOST_TYPED_CALL_NAME_REAL($1,in),
	HOST_TYPED_CALL_NAME_REAL($1,di),
	HOST_TYPED_CALL_NAME_REAL($1,li),
...
define(`ALL_ARR_SSE',`{ $2, { ALL_REAL_NO_BITMAP_SSE($1), ALL_COMPLEX($1), ALL_MIXED($1), ALL_NULL, ALL_NULL } }')

define(`RCQALL_ARR_SSE',`{ $2, { ALL_REAL_NO_BITMAP_SSE($1), ALL_COMPLEX($1), ALL_NULL, ALL_QUAT($1), ALL_NULL } }')

define(`RCQALL_SAME_PREC_ARR_SSE',`{ $2, { ALL_REAL_SAME_PREC_NO_GPUBITMAP_SSE($1), ALL_COMPLEX($1), ALL_NULL, ALL_QUAT($1), ALL_NULL } }')

define(`QALL_ARR_SSE',`{ $2, { ALL_REAL_NO_BITMAP_SSE($1), ALL_COMPLEX($1), ALL_MIXED($1), ALL_QUAT($1), ALL_NULL } }')
define(`RCMQPALL_ARR_SSE',`{ $2, { ALL_REAL_NO_BITMAP_SSE($1), ALL_COMPLEX($1), ALL_MIXED($1), ALL_QUAT($1), ALL_QMIXD($1) } }')

',` dnl else /* ! USE_SSE */

define(`ALL_ARR_SSE',`ALL_ARR( $1, $2 )')
define(`RCQALL_ARR_SSE',`RCQALL_ARR( $1, $2 )')
define(`RCQALL_SAME_PREC_ARR_SSE',`RCQALL_SAME_PREC_ARR( $1, $2 )')
define(`QALL_ARR_SSE',`QALL_ARR( $1, $2 )')
define(`RCMQPALL_ARR_SSE',`RCMQPALL_ARR( $1, $2 )')
