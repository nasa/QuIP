...
define(`DECL_INDICES_LUTMAP_B',`DECL_INDICES_2')
define(`DECL_INDICES_LUTMAP_S',`DECL_INDICES_2')
...
define(`SET_INDICES_LUTMAP_S',`SET_INDICES_2')
...
define(`SCALE_INDICES_LUTMAP_B',SCALE_INDICES_2)
define(`SCALE_INDICES_LUTMAP_S',SCALE_INDICES_2)
