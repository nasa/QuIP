...
//define(`SCALE_INDICES_SBM',SCALE_INDEX(sbmi,sbm_inc))
//define(`SCALE_INDICES_DBM',SCALE_INDEX(dbmi,dbm_inc))
...
define(`SCALE_INDICES_FAST_1',`')
define(`SCALE_INDICES_FAST_2',`')
define(`SCALE_INDICES_FAST_3',`')
define(`SCALE_INDICES_FAST_4',`')
define(`SCALE_INDICES_FAST_5',`')
...
define(`SCALE_INDICES_EQSP_DBM_1S_',`')
