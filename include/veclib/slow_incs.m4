...
define(`DECL_SLOW_INCRS_LUTMAP_B',`DECL_SLOW_INCRS_2')
define(`DECL_SLOW_INCRS_LUTMAP_S',`DECL_SLOW_INCRS_2')
...
define(`SETUP_SLOW_INCS_2',`SETUP_SLOW_INCS_1 SETUP_SLOW_INCS_SRC1')
define(`SETUP_SLOW_INCS_LUTMAP_B',`SETUP_SLOW_INCS_2')
define(`SETUP_SLOW_INCS_LUTMAP_S',`SETUP_SLOW_INCS_2')

define(`SETUP_SLOW_INCS_3',`SETUP_SLOW_INCS_2 SETUP_SLOW_INCS_SRC2')

define(`SETUP_SLOW_INCS_4',`SETUP_SLOW_INCS_3 SETUP_SLOW_INCS_SRC3')

define(`SETUP_SLOW_INCS_5',`SETUP_SLOW_INCS_4 SETUP_SLOW_INCS_SRC4')
...
define(`SETUP_SLOW_INCS_SBM_1',`SETUP_SLOW_INCS_1 SETUP_SLOW_INCS_SBM')

define(`SETUP_SLOW_INCS_SBM_2',`SETUP_SLOW_INCS_2 SETUP_SLOW_INCS_SBM')
