...
// These can be defined to print for debugging...
#define REPORT_DIM3_VAR(v)						\
...
// BUG VA_ARGSET_PREC appears to be invalid - not copied from oap?
...
#define REPORT_SLEN_ARGS_1S_1		\
					\
REPORT_SLOW_ARGS_1S_1			\
REPORT_DIM3_VAR(VA_XYZ_LEN(vap))
