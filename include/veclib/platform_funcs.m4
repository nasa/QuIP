...
dnl	// streams could be done on a cpu also?
dnl	// Or just let OpenCL handle it?
...
dnl	// These are used by vl2 also

dnl	Should the fft functions be here too?

dnl	// these are probably redundant!?
