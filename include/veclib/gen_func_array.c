...
RCQALL_SAME_PREC_ARR_SSE(		vset,		FVSET ),
...
RCQALL_SAME_PREC_ARR_SSE(		vmov,		FVMOV ),
...
RCMQPALL_ARR_SSE(		vsadd,		FVSADD ),
RCMQPALL_ARR_SSE(		vssub,		FVSSUB ),
RCMQPALL_ARR_SSE(		vsmul,		FVSMUL ),
RCMQPALL_ARR_SSE(		vsdiv,		FVSDIV ),
RCMQPALL_ARR_SSE(		vsdiv2,		FVSDIV2 ),
RCMQPALL_ARR_SSE(		vssub2,		FVSSUB2 ),
RALL_ARR(		vabs,		FVABS ),
