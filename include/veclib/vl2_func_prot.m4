...
dnl extern void h_vl2_fft2d( FFT_FUNC_ARG_DECLS );
dnl extern void h_vl2_ift2d( FFT_FUNC_ARG_DECLS );
dnl extern void h_vl2_fftrows( FFT_FUNC_ARG_DECLS );
dnl extern void h_vl2_iftrows( FFT_FUNC_ARG_DECLS );
