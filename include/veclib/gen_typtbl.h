#ifndef _GEN_TYPTBL_H_
#define _GEN_TYPTBL_H_
...
#define RFLT_SAME_PREC_ALL(stem)						\
								\
	NULL_4,							\
	HOST_TYPED_CALL_NAME_REAL(stem,sp),				\
	HOST_TYPED_CALL_NAME_REAL(stem,dp),				\
...
#define ALL_SAME_PREC_NO_BITMAP(stem)				\
								\
	HOST_TYPED_CALL_NAME(stem,by),				\
	HOST_TYPED_CALL_NAME(stem,in),				\
	HOST_TYPED_CALL_NAME(stem,di),				\
...
#define ALL_REAL_SAME_PREC(stem)				\
								\
	HOST_TYPED_CALL_NAME_REAL(stem,by),			\
	HOST_TYPED_CALL_NAME_REAL(stem,in),			\
	HOST_TYPED_CALL_NAME_REAL(stem,di),			\
...
#define RFLT_SAME_PREC_ARR( stem, code )				\
	{ code, { FLT_SAME_PREC_ALL(stem), ALL_NULL, ALL_NULL, ALL_NULL, ALL_NULL } }
...
#define RALL_SAME_PREC_ARR( stem, code )						\
	{ code, { ALL_SAME_PREC_NO_BITMAP(stem), ALL_NULL, ALL_NULL, ALL_NULL, ALL_NULL	} }
