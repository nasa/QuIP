...
// Bitmaps don't need OS_ARG, they get the offset from bit0
dnl define(`GEN_ARGS_FAST_SBM',$1`_FAST_SBM' OS_ARG($1,SBM))
dnl define(`GEN_ARGS_FAST_SBM1',$1`_FAST_SBM1' OS_ARG($1,SBM1))
dnl define(`GEN_ARGS_FAST_SBM2',$1`_FAST_SBM2' OS_ARG($1,SBM2))
dnl define(`GEN_ARGS_FAST_DBM',$1`_FAST_DBM' OS_ARG($1,DBM))
define(`GEN_ARGS_FAST_SBM',$1`_FAST_SBM')
define(`GEN_ARGS_FAST_SBM1',$1`_FAST_SBM1')
define(`GEN_ARGS_FAST_SBM2',$1`_FAST_SBM2')
define(`GEN_ARGS_FAST_DBM',$1`_FAST_DBM')
