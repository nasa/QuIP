...
extern void dp_jacobi(Data_Obj *v_dp,Data_Obj *d_dp,Data_Obj *a_dp,int *);
extern void dp_eigsrt(Data_Obj *v_dp,Data_Obj *d_dp);
extern void dp_moment(Data_Obj *d_dp);
